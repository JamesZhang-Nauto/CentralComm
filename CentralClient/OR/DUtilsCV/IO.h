...
public:
  ...
  inline static void save(const std::string &filename, 
    const cv::FernDescriptorMatcher &c,
...
inline void IO::save(const std::string &filename, 
    ...
    const std::string &nodename)
{
  IO::save<cv::FernDescriptorMatcher>(filename, c, nodename);
}
...
inline void IO::load(const std::string &filename, 
    ...
    const std::string &nodename)
{
  IO::load<cv::FernDescriptorMatcher>(filename, c, nodename);
}
