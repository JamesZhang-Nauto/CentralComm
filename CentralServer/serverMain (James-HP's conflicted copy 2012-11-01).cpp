...
void robotMotion( );
extern int goals[8];// = {310,1000,  -800,1140,  -2000,1500,  -2000,-30};
extern int headings[4];// = {0,-90,180,90};
extern int goalIndex;// = 0;
...
//   KeyPTU ptz(&robot); 		//create keyboard for control vcc50i
  ...
  robot.unlock();
  //locTask.forceUpdatePose(ArPose(-450,-1100,0));
